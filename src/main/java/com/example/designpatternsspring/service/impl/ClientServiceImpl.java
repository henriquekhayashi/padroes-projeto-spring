...
import com.example.designpatternsspring.model.ClienteRepository;
import com.example.designpatternsspring.model.Endereco;
import com.example.designpatternsspring.model.EnderecoRepository;
...
public class ClientServiceImpl implements ClienteService {
	...
	@Override
	public Iterable<Cliente> buscarPorUF(String uf) {
		return clienteRepository.findByEnderecoUf(uf);
	}
